...
-keep class com.MeshLink.android.protocol.** { *; }
-keep class com.MeshLink.android.crypto.** { *; }
-dontwarn org.bouncycastle.**
-keep class org.bouncycastle.** { *; }

# Keep SecureIdentityStateManager from being obfuscated to prevent reflection issues
-keep class com.MeshLink.android.identity.SecureIdentityStateManager {
    private android.content.SharedPreferences prefs;
    *;
}

# Keep all classes that might use reflection
-keep class com.MeshLink.android.favorites.** { *; }
-keep class com.MeshLink.android.nostr.** { *; }
-keep class com.MeshLink.android.identity.** { *; }

# Keep Tor implementation (always included)
-keep class com.MeshLink.android.net.RealTorProvider { *; }
