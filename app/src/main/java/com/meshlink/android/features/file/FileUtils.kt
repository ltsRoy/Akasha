package com.MeshLink.android.features.file
...
object FileUtils {
    ...
    fun saveIncomingFile(
        context: Context,
        file: com.MeshLink.android.model.MeshLinkFilePacket
    ): String {
    ...
    /**
     * Classify MeshLinkMessageType from MIME string used in file messages.
     */
    fun messageTypeForMime(mime: String): com.MeshLink.android.model.MeshLinkMessageType {
        val lower = mime.lowercase()
        return when {
            lower.startsWith("image/") -> com.MeshLink.android.model.MeshLinkMessageType.Image
            lower.startsWith("audio/") -> com.MeshLink.android.model.MeshLinkMessageType.Audio
            else -> com.MeshLink.android.model.MeshLinkMessageType.File
        }
    }
