...
import com.MeshLink.android.ui.MessageManager
    ...
    fun onEvent(event: NostrEvent, subscribedGeohash: String) {
        scope.launch(Dispatchers.Default) {
            try {
                ...
                try {
                    com.MeshLink.android.nostr.GeohashAliasRegistry.put("nostr_${event.pubkey.take(16)}", event.pubkey)
                } catch (_: Exception) { }
                ...
                val type = if (com.MeshLink.android.model.parseLocation(event.content) != null) {
