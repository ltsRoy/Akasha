...
/**
 * MeshLink-over-Nostr Adapter
 * Direct port from iOS implementation for 100% compatibility
 */
object NostrEmbeddedMeshLink {
    
    private const val TAG = "NostrEmbeddedMeshLink"
    
    /**
     * Build a `MeshLink1:` base64url-encoded MeshLink packet carrying a private message for Nostr DMs.
     */
    fun encodePMForNostr(
        ...
        try {
            ...
            return "MeshLink1:" + base64URLEncode(data)
        } catch (e: Exception) {
    ...
    /**
     * Build a `MeshLink1:` base64url-encoded MeshLink packet carrying a delivery/read ack for Nostr DMs.
     */
    ...
    /**
     * Build a `MeshLink1:` ACK (delivered/read) without an embedded recipient peer ID (geohash DMs).
     */
    ...
    /**
     * Build a `MeshLink1:` payload without an embedded recipient peer ID (used for geohash DMs).
     */
