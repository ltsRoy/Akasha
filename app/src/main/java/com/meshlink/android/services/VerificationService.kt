...
object VerificationService {
    private const val CONTEXT = "MeshLink-verify-v1"
    private const val RESPONSE_CONTEXT = "MeshLink-verify-resp-v1"
    ...
    data class VerificationQR(
        ...
        companion object {
            fun fromUrlString(urlString: String): VerificationQR? {
                ...
                if (uri.scheme != "MeshLink" || uri.host != "verify") return null
