package com.MeshLink.android.crypto
...
import com.MeshLink.android.noise.NoiseEncryptionService
 ...
 * 
 * This is the main interface for all encryption/decryption operations in MeshLink.
...
open class EncryptionService(private val context: Context) {
    ...
    companion object {
        ...
        private const val OLD_PREFS_NAME = "MeshLink_crypto"
        private const val SECURE_PREFS_NAME = "MeshLink_crypto_secure"
    }
