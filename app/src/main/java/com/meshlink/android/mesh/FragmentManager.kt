...
import com.MeshLink.android.model.FragmentPayload
...
class FragmentManager {
    ...
    companion object {
        ...
        private const val FRAGMENT_SIZE_THRESHOLD = com.MeshLink.android.util.AppConstants.Fragmentation.FRAGMENT_SIZE_THRESHOLD // Matches iOS: if data.count > 512
        private const val MAX_FRAGMENT_SIZE = com.MeshLink.android.util.AppConstants.Fragmentation.MAX_FRAGMENT_SIZE        // Matches iOS: maxFragmentSize = 469 
        private const val FRAGMENT_TIMEOUT = com.MeshLink.android.util.AppConstants.Fragmentation.FRAGMENT_TIMEOUT_MS     // Matches iOS: 30 seconds cleanup
        private const val CLEANUP_INTERVAL = com.MeshLink.android.util.AppConstants.Fragmentation.CLEANUP_INTERVAL_MS     // 10 seconds cleanup check
    }
     ...
     */
    fun createFragments(packet: MeshLinkPacket): List<MeshLinkPacket> {
        try {
        ...
        val fragments = mutableListOf<MeshLinkPacket>()
        ...
        for (index in fragmentChunks.indices) {
            ...
            val fragmentPacket = MeshLinkPacket(
     ...
     */
    fun handleFragment(packet: MeshLinkPacket): MeshLinkPacket? {
        ...
        try {
            ...
            val maxFragments = com.MeshLink.android.util.AppConstants.Fragmentation.MAX_FRAGMENTS_PER_ID
            ...
            synchronized(fragmentStateLock) {
                ...
                if (isNewSet) {
                    val maxActive = com.MeshLink.android.util.AppConstants.Fragmentation.MAX_ACTIVE_FRAGMENT_SETS
                ...
                val maxTotalBytes = com.MeshLink.android.util.AppConstants.Fragmentation.MAX_FRAGMENT_TOTAL_BYTES
                ...
                val maxGlobalBytes = com.MeshLink.android.util.AppConstants.Fragmentation.MAX_GLOBAL_FRAGMENT_TOTAL_BYTES
                ...
                if (fragmentMap.size == expectedTotal) {
                    ...
                    val originalPacket = MeshLinkPacket.fromBinaryData(reassembledData.toByteArray())
...
interface FragmentManagerDelegate {
    fun onPacketReassembled(packet: MeshLinkPacket)
}
