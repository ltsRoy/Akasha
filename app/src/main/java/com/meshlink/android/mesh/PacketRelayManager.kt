 ...
 * 
 * This class handles all relay decisions and logic for MeshLink packets.
...
class PacketRelayManager(private val myPeerID: String) {
    ...
    private fun isRelayEnabled(): Boolean = try {
        com.MeshLink.android.ui.debug.DebugSettingsManager.getInstance().packetRelayEnabled.value
     ...
     */
    internal fun isPacketAddressedToMe(packet: MeshLinkPacket): Boolean {
     ...
     */
    private fun shouldRelayPacket(packet: MeshLinkPacket, fromPeerID: String): Boolean {
