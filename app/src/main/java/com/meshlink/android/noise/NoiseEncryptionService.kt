package com.MeshLink.android.noise

import android.content.Context
import android.util.Log
import com.MeshLink.android.identity.SecureIdentityStateManager
import com.MeshLink.android.mesh.PeerFingerprintManager
import com.MeshLink.android.noise.southernstorm.protocol.Noise
...
class NoiseEncryptionService(private val context: Context) {
    ...
    companion object {
        ...
        private const val REKEY_TIME_LIMIT = com.MeshLink.android.util.AppConstants.Noise.REKEY_TIME_LIMIT_MS // 1 hour (same as iOS)
        private const val REKEY_MESSAGE_LIMIT = com.MeshLink.android.util.AppConstants.Noise.REKEY_MESSAGE_LIMIT_ENCRYPTION // 1k messages (matches iOS) (same as iOS)
    }
    ...
    /**
     * Sign a MeshLinkPacket using our Ed25519 signing key
     */
    fun signPacket(packet: com.MeshLink.android.protocol.MeshLinkPacket): com.MeshLink.android.protocol.MeshLinkPacket? {
    ...
    /**
     * Verify a MeshLinkPacket signature using the provided public key
     */
    fun verifyPacketSignature(packet: com.MeshLink.android.protocol.MeshLinkPacket, publicKey: ByteArray): Boolean {
