...
import com.MeshLink.android.features.file.FileUtils
 ...
 */
private fun tryOpenFile(context: Context, packet: MeshLinkFilePacket) {
    try {
        // First try to save to temp file and open
        val tempFile = File.createTempFile("MeshLink_", ".${packet.fileName.substringAfterLast(".")}", context.cacheDir)
