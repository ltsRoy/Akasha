...
import com.MeshLink.android.ui.media.FullScreenImageViewer
...
fun ChatScreen(viewModel: ChatViewModel) {
    ...
    var selectedMessageForSheet by remember { mutableStateOf<MeshLinkMessage?>(null) }
    var showFullScreenImageViewer by remember { mutableStateOf(false) }
    var viewerImagePaths by remember { mutableStateOf(emptyList<String>()) }
    var initialViewerIndex by remember { mutableStateOf(0) }
    var forceScrollToBottom by remember { mutableStateOf(false) }
    var isScrolledUp by remember { mutableStateOf(false) }
    var showAriaSheet by remember { mutableStateOf(false) }
    ...
    val sendSosWithLocation = {
        viewModel.sendMessage("🆘 EMERGENCY SOS BROADCAST")
        ...
        if (androidx.core.content.ContextCompat.checkSelfPermission(
            ...
            fusedLocationClient.lastLocation.addOnSuccessListener { location ->
                if (location != null) {
                    viewModel.sendMessage("📍 Location Shared: ${location.latitude}, ${location.longitude}")
                }
            }
        }
    }
    ...
    val displayMessages = when {
        currentChannel != null -> channelMessages[currentChannel] ?: emptyList()
            ...
            if (locationChannel is com.MeshLink.android.geohash.ChannelID.Location) {
    ...
    val showMediaButtons = when {
        ...
        else -> selectedLocationChannel !is com.MeshLink.android.geohash.ChannelID.Location
    }
        ...
        Column(
            ...
            MessagesList(
                ...
                onNicknameClick = { fullSenderName ->
                    ...
                    val mentionText = if (selectedLocationChannel is com.MeshLink.android.geohash.ChannelID.Location && hashSuffix.isNotEmpty()) {
    ...
    androidx.compose.runtime.LaunchedEffect(Unit) {
        com.MeshLink.android.ui.events.FileShareDispatcher.setHandler { peer, channel, path ->
    ...
    ChatInputSection(
        ...
        ChatFloatingHeader(
            ...
            onAriaClick = { showAriaSheet = true }
        )
            ...
            Surface(
                ...
                IconButton(onClick = { forceScrollToBottom = !forceScrollToBottom }) {
                    Icon(
                        ...
                        contentDescription = stringResource(com.MeshLink.android.R.string.cd_scroll_to_bottom),
    ...
    if (showAriaSheet) {
        val ariaViewModel: com.MeshLink.android.ai.AriaViewModel = androidx.lifecycle.viewmodel.compose.viewModel()
        com.MeshLink.android.ui.AriaChatSheet(
            isPresented = showAriaSheet,
            onDismiss = { showAriaSheet = false },
...
private fun ChatFloatingHeader(
    ...
    val context = androidx.compose.ui.platform.LocalContext.current
    val locationManager = remember { com.MeshLink.android.geohash.LocationChannelManager.getInstance(context) }
...
private fun ChatDialogs(
    ...
    selectedMessageForSheet: MeshLinkMessage?,
    viewModel: ChatViewModel,
    ...
    // Settings sheet — the single Akasha settings surface, shared with the home screen.
    var showDebugSheet by remember { mutableStateOf(false) }
    com.MeshLink.android.ui.home.AkashaSettingsSheet(
