...
import com.MeshLink.android.nostr.GeohashMessageHandler
import com.MeshLink.android.nostr.GeohashRepository
import com.MeshLink.android.nostr.NostrDirectMessageHandler
import com.MeshLink.android.nostr.NostrIdentityBridge
import com.MeshLink.android.nostr.NostrProtocol
import com.MeshLink.android.nostr.NostrRelayManager
import com.MeshLink.android.nostr.NostrSubscriptionManager
import com.MeshLink.android.nostr.PoWPreferenceManager
import com.MeshLink.android.nostr.GeohashAliasRegistry
import com.MeshLink.android.nostr.GeohashConversationRegistry
...
class GeohashViewModel(
    ...
    private var locationChannelManager: com.MeshLink.android.geohash.LocationChannelManager? = null
    ...
    fun initialize() {
        ...
        try {
            locationChannelManager = com.MeshLink.android.geohash.LocationChannelManager.getInstance(getApplication())
            ...
            state.setSelectedLocationChannel(com.MeshLink.android.geohash.ChannelID.Mesh)
    ...
    fun sendGeohashMessage(content: String, channel: com.MeshLink.android.geohash.GeohashChannel, myPeerID: String, nickname: String?) {
        viewModelScope.launch {
            try {
                ...
                val localMsg = com.MeshLink.android.model.MeshLinkMessage(
                    id = tempId,
                ...
                if (startedMining) {
                    com.MeshLink.android.ui.PoWMiningTracker.startMiningMessage(tempId)
                }
                try {
                    ...
                    if (startedMining) {
                        com.MeshLink.android.ui.PoWMiningTracker.stopMiningMessage(tempId)
                    }
                }
            } catch (e: Exception) {
    ...
    fun startGeohashDM(pubkeyHex: String, onStartPrivateChat: (String) -> Unit) {
        ...
        val gh = (current as? com.MeshLink.android.geohash.ChannelID.Location)?.channel?.geohash
        if (!gh.isNullOrEmpty()) {
    ...
    fun blockUserInGeohash(targetNickname: String) {
        ...
        if (pubkey != null) {
            ...
            val sysMsg = com.MeshLink.android.model.MeshLinkMessage(
                sender = "system",
    ...
    private fun switchLocationChannel(channel: com.MeshLink.android.geohash.ChannelID?) {
        ...
        when (channel) {
            is com.MeshLink.android.geohash.ChannelID.Mesh -> {
            ...
            is com.MeshLink.android.geohash.ChannelID.Location -> {
