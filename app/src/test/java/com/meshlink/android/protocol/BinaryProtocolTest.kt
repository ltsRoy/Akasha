...
class BinaryProtocolTest {
     ...
     * anything it can't parse as a valid MeshLinkPacket.
     */
    @Test
    ...
    fun `sender ID is padded or truncated to exactly 8 bytes`() {
        ...
        val shortPacket = MeshLinkPacket(
            version = 1u,
    ...
    private fun roundTrip(packet: MeshLinkPacket): MeshLinkPacket {
    ...
    private fun assertPacketEquals(expected: MeshLinkPacket, actual: MeshLinkPacket) {
